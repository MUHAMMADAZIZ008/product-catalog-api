...
cartsRouter.post('/', checkValidatons(cartSchema), authGuard(secret), roleGuard(role), createCartController)
cartsRouter.get('/', getAllCartController)
cartsRouter.get('/:id', getByIdCartController)
cartsRouter.put('/:id', authGuard(secret), roleGuard(role), updateCartController)
cartsRouter.delete('/:id', authGuard(secret), roleGuard(role), deleteCartController)
