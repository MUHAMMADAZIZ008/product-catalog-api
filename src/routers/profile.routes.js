...
profileRouter.get('/user/:user_id',authGuard, roleGuard(['user','admin','manager']),  profilesController.getByUserId)
profileRouter.post(
    '/',
    authGuard, roleGuard(['user','admin','manager']), 
    checkValidatons(profileSchema),
    profilesController.create,
)
profileRouter.put('/:id', profilesController.update)
profileRouter.delete('/:id',authGuard, roleGuard(['admin','manager']),  profilesController.delete)
